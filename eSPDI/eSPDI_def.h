...
#define ETronDI_DEPTH_DATA_14_BITS_COMBINED_RECTIFY     11// 
...
#define ETronDI_DEPTH_DATA_ILM_OFF_RAW			ETronDI_DEPTH_DATA_OFF_RAW + ETronDI_DEPTH_DATA_INTERLEAVE_MODE_OFFSET /* raw (depth off, only raw color) */
#define ETronDI_DEPTH_DATA_ILM_DEFAULT			ETronDI_DEPTH_DATA_DEFAULT + ETronDI_DEPTH_DATA_INTERLEAVE_MODE_OFFSET /* raw (depth off, only raw color) */
#define ETronDI_DEPTH_DATA_ILM_8_BITS			ETronDI_DEPTH_DATA_8_BITS + ETronDI_DEPTH_DATA_INTERLEAVE_MODE_OFFSET /* rectify, 1 byte per pixel */
#define ETronDI_DEPTH_DATA_ILM_14_BITS			ETronDI_DEPTH_DATA_14_BITS + ETronDI_DEPTH_DATA_INTERLEAVE_MODE_OFFSET /* rectify, 2 byte per pixel */
#define ETronDI_DEPTH_DATA_ILM_8_BITS_x80		ETronDI_DEPTH_DATA_8_BITS_x80 + ETronDI_DEPTH_DATA_INTERLEAVE_MODE_OFFSET /* rectify, 2 byte per pixel but using 1 byte only */
#define ETronDI_DEPTH_DATA_ILM_11_BITS			ETronDI_DEPTH_DATA_11_BITS + ETronDI_DEPTH_DATA_INTERLEAVE_MODE_OFFSET /* rectify, 2 byte per pixel but using 11 bit only */
#define ETronDI_DEPTH_DATA_ILM_OFF_RECTIFY		ETronDI_DEPTH_DATA_OFF_RECTIFY + ETronDI_DEPTH_DATA_INTERLEAVE_MODE_OFFSET /* rectify (depth off, only rectify color) */
#define ETronDI_DEPTH_DATA_ILM_8_BITS_RAW		ETronDI_DEPTH_DATA_8_BITS_RAW + ETronDI_DEPTH_DATA_INTERLEAVE_MODE_OFFSET /* raw */
#define ETronDI_DEPTH_DATA_ILM_14_BITS_RAW		ETronDI_DEPTH_DATA_14_BITS_RAW + ETronDI_DEPTH_DATA_INTERLEAVE_MODE_OFFSET /* raw */
#define ETronDI_DEPTH_DATA_ILM_8_BITS_x80_RAW	ETronDI_DEPTH_DATA_8_BITS_x80_RAW + ETronDI_DEPTH_DATA_INTERLEAVE_MODE_OFFSET /* raw */
#define ETronDI_DEPTH_DATA_ILM_11_BITS_RAW		ETronDI_DEPTH_DATA_11_BITS_RAW + ETronDI_DEPTH_DATA_INTERLEAVE_MODE_OFFSET /* raw */
#define ETronDI_DEPTH_DATA_ILM_14_BITS_COMBINED_RECTIFY     ETronDI_DEPTH_DATA_14_BITS_COMBINED_RECTIFY + ETronDI_DEPTH_DATA_INTERLEAVE_MODE_OFFSET//
#define ETronDI_DEPTH_DATA_ILM_11_BITS_COMBINED_RECTIFY     ETronDI_DEPTH_DATA_11_BITS_COMBINED_RECTIFY + ETronDI_DEPTH_DATA_INTERLEAVE_MODE_OFFSET// multi-baseline
...
#define ETronDI_PID_GRAP    0x0179
...
#define ETronDI_VID_GRAP_THERMAL 0x04b4
//-[Thermal device]
#define ETronDI_VID_2170 0x0110
